...
IL_0044:
		...
		{// begin try (depth: 1)
			...
			NullCheck(L_9);
			int32_t L_12;
			L_12 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(28 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_9, L_10, 0, ((int32_t)(((RuntimeArray*)L_11)->max_length)));
			FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8* L_13 = V_1;
			NullCheck(L_13);
			VirtualActionInvoker0::Invoke(14 /* System.Void System.IO.Stream::Close() */, L_13);
			goto IL_0045;
		}// end try (depth: 1)
		catch(Il2CppExceptionWrapper& e)
		{
